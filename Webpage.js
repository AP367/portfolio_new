...
function About() {
  ...
  const shortBio = `I'm Adhish Paudel, an Electrical Engineering undergraduate at the Institute of Engineering, Pulchowk Campus — one of Nepal's most prestigious technical institutions. From a young age, I was drawn to how things work: circuits, systems, and the invisible forces that power our world. That curiosity eventually became a calling. Today, I channel it into hands-on projects involving embedded systems, power electronics, and automation. I believe that real engineering is learned by building — not just by reading textbooks.`;
  const fullBio = [
    `I'm Adhish Paudel, an Electrical Engineering undergraduate at the Institute of Engineering, Pulchowk Campus — one of Nepal's most prestigious technical institutions. From a young age, I was drawn to how things work: circuits, systems, and the invisible forces that power our world. That curiosity eventually became a calling. Today, I channel it into hands-on projects involving embedded systems, power electronics, and automation. I believe that real engineering is learned by building — not just by reading textbooks.`,
    `Beyond the lab bench, I'm deeply interested in the startup ecosystem and how engineering knowledge can be transformed into scalable, real-world products. I think the most impactful engineers of the next decade will be those who can bridge the gap between hardware and business — and that's the kind of engineer I'm working to become.`,
    `My academic journey started at Takshashila Academy and Meridian International School, where a love for mathematics and science quietly shaped my direction. After completing +2 Science, I made it to Pulchowk Campus — where I'm surrounded by driven peers, rigorous coursework, and opportunities to push well beyond the curriculum.`,
    `When I'm not deep in circuit diagrams or debugging firmware, you'll find me on a trail somewhere in the hills of Nepal, writing in my travel diary, or exploring how the world outside the classroom can teach things no textbook ever could. Life, for me, is one long engineering project — full of problems worth solving.`,
  ];
